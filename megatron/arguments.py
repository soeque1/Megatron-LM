...
def _add_mixed_precision_args(parser):
    ...
    group.add_argument('--apply-query-key-layer-scaling',
                       action='store_true',
    ...
    group.add_argument('--fp32-allreduce',
                       action='store_true',
...
def _add_data_args(parser):
    ...
    group.add_argument('--reset-attention-mask',
                       action='store_true',
...
def _add_realm_args(parser):
    ...
    # training
    group.add_argument('--report-topk-accuracies',
                       nargs='+',
                       default=[],
                       help="Which top-k accuracies to report (e.g. '1 5 20')")

    # faiss index
    group.add_argument('--faiss-use-gpu',
                       action='store_true',
